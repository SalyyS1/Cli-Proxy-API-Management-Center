    ...
    <div className={styles.container}>
      ...
      <GlassCard>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          <h2 style={{ margin: 0, fontSize: 18, fontWeight: 600 }}>{t('system_info.connection_status_title')}</h2>
      ...
      <GlassCard>
        <h2 style={{ margin: '0 0 8px 0', fontSize: 18, fontWeight: 600 }}>{t('system_info.quick_links_title')}</h2>
        <p className={styles.sectionDescription}>{t('system_info.quick_links_desc')}</p>
        <BentoGrid columns={3} gap="md" className={styles.quickLinks}>
          <BentoItem>
            <a
      ...
      <GlassCard>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <h2 style={{ margin: 0, fontSize: 18, fontWeight: 600 }}>{t('system_info.models_title')}</h2>
      ...
      <GlassCard>
        <h2 style={{ margin: '0 0 8px 0', fontSize: 18, fontWeight: 600 }}>{t('system_info.clear_login_title')}</h2>
